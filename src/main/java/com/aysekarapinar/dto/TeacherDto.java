...
public class TeacherDto {
    ...
    public TeacherDto(Integer id, String name, String surname, LocalDate birthDate,
    ...
    public TeacherDto(Integer id, String name, String surname, LocalDate birthDate, EStudentType eStudentType, ERole eRole) {
        this(id, name, surname, birthDate, 0.0, 0.0, eStudentType, eRole);
    }

    public TeacherDto(int generatedId, String name, String surname, LocalDate birthDate, ETeacherSubject eTeacherSubject, int yearsOfExperience, boolean b, double salary) {
    }
